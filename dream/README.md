...
model_fast_dllm文件夹下是dream相关代码（fast-dllm改进版），model_origin文件夹下面是原生dream代码。
model_apd文件夹下是apd工作中的dream model相关代码（apd改进版），model_new是结合了fast_dllm和我项目的rag热启动思路的代码。
...
mix_dream.py是我的项目结合fast-dllm适配dream后的代码。
